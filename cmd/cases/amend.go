...
// AmendCmd's BodyFile and Context are pointers so that a flag given an empty
// value can be told from a flag left out.
type AmendCmd struct {
	ID       string   `arg:"" help:"Case id."`
	BodyFile *string  `help:"Markdown that replaces the body. - reads stdin." name:"body-file" placeholder:"FILE"`
